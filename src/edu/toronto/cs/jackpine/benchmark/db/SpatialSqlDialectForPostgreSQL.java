...
public class SpatialSqlDialectForPostgreSQL extends SqlDialectForPostgreSQL implements SpatialSqlDialect
{
  ...
  public String getSelectLongestLine(){
	  ...
	  // Generate the join SQL statement.
	  sb.append("SELECT  fullname, ST_Length(geom) AS line FROM edges_merge order BY line DESC limit 1");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  ...
  public  String getSelectLargestArea(){ 
	  ...
	  // Generate the join SQL statement.
	  sb.append("SELECT  fullname, ST_Area(geom) AS area FROM areawater_merge order BY area DESC limit 1");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String[] getSelectLongestLineIntersectsArea(){ 
	  //StringBuffer sb = new StringBuffer();
	  //sb.append("select count(*) from  areawater_merge a, edges_merge e where ST_Intersects(e.geom, a.geom) and e.gid= (select gid from edges_merge order by ST_Length(geom) desc limit 1)");
	  //String sql = sb.toString();
  ...
  public String[] getSelectLineIntersectsLargestArea(){ 
	  //StringBuffer sb = new StringBuffer();
	  //sb.append("select count(*) from  arealm_merge a, edges_merge e where ST_Intersects(e.geom, a.geom) and a.gid= (select gid from arealm_merge order by ST_Area(geom) desc limit 1)");
	  //String sql = sb.toString();
  ...
  public String[] getSelectAreaOverlapsLargestArea(){ 
	  //StringBuffer sb = new StringBuffer();
	  //sb.append("select count(*) from  arealm_merge al, areawater_merge aw where ST_Overlaps(al.geom, aw.geom) and al.gid= (select gid from arealm_merge order by ST_Area(geom) desc limit 1)");
	  //String sql = sb.toString();
  ...
  public String[] getSelectLargestAreaContainsPoint(){ 
	  //StringBuffer sb = new StringBuffer();
	  //sb.append("select count(*) from  pointlm_merge pl, areawater_merge aw where ST_Contains(aw.geom, pl.geom) and aw.gid= (select gid from areawater_merge order by ST_Area(geom) desc limit 1)");
	  //String sql = sb.toString();
  ...
  public String getSelectAreaOverlapsArea(){ 
	  StringBuffer sb = new StringBuffer();
	  sb.append("select a1.fullname from  arealm_merge a1 , arealm_merge a2 where ST_overlaps(a1.geom, a2.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String getSelectAreaContainsArea(){  
	  StringBuffer sb = new StringBuffer();
  	  sb.append("select a1.fullname from  arealm_merge a1 , arealm_merge a2 where ST_contains(a1.geom, a2.geom)");
  	  String sql = sb.toString();
  	  // System.out.println("The query "+ sql);
  	  return sql;
  }
  ...
  public String getSelectAreaWithinArea(){ 
	  StringBuffer sb = new StringBuffer();
  	  sb.append("select a1.fullname from  arealm_merge a1 , arealm_merge a2 where ST_within(a1.geom, a2.geom)");
  	  String sql = sb.toString();
  	  // System.out.println("The query "+ sql);
  	  return sql;
  }
  ...
  public String getSelectAreaTouchesArea(){ 
	  StringBuffer sb = new StringBuffer();
  	  sb.append("select a1.fullname from  arealm_merge a1 , arealm_merge a2 where ST_touches(a1.geom, a2.geom)");
  	  String sql = sb.toString();
  	  // System.out.println("The query "+ sql);
  	  return sql;
  }
  ...
  public String getSelectAreaEqualsArea(){ 
	  StringBuffer sb = new StringBuffer();
  	  sb.append("select a1.fullname from  arealm_merge a1 , arealm_merge a2 where ST_equals(a1.geom, a2.geom)");
  	  String sql = sb.toString();
  	  // System.out.println("The query "+ sql);
  	  return sql;
  }
  ...
  public String getSelectAreaDisjointArea(){ 
	  StringBuffer sb = new StringBuffer();
	  sb.append("select count(*) from  arealm_merge a1, arealm_merge a2 where ST_Disjoint(a1.geom, a2.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public  String getSelectLineIntersectsArea(){
	  ...
	  // Generate the join SQL statement.
	  sb.append("select a.fullname, e.fullname from  arealm_merge a, edges_merge e where ST_Intersects(e.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public  String getSelectLineOverlapsArea(){ 
	  ...
	  // Generate the join SQL statement.
	  sb.append("select a.fullname, e.fullname from  arealm_merge a, edges_merge e where ST_Overlaps(e.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String getSelectLineCrossesArea(){
	  StringBuffer sb = new StringBuffer();
	  sb.append("select e.fullname from  edges_merge e , arealm_merge a where ST_crosses(e.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String getSelectLineWithinArea(){
	  StringBuffer sb = new StringBuffer();
	  sb.append("select e.fullname from  edges_merge e , arealm_merge a where ST_within(e.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String getSelectLineTouchesArea(){
	  StringBuffer sb = new StringBuffer();
	  sb.append("select e.fullname from  edges_merge e , arealm_merge a where ST_Touches(e.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql; 
  }
  ...
  public String getSelectLineOverlapsLine(){ 
	  ...
	  // Generate the join SQL statement. 
	  sb.append("select e1.fullname  from  edges_merge e1 , edges_merge e2 where ST_overlaps(e1.geom, e2.geom) limit 1 ");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String getSelectLineCrossesLine(){ 
	  ...
	  // Generate the join SQL statement. 
	  sb.append("select e1.fullname  from  edges_merge e1 , edges_merge e2 where ST_crosses(e1.geom, e2.geom) limit 1 ");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public  String getSelectPointWithinArea(){ 
	  ...
	  // Generate the join SQL statement.
	  sb.append("select count(*) from  arealm_merge a, pointlm_merge p where ST_Within(p.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }   
  ...
  public  String getSelectPointIntersectsArea(){
	  StringBuffer sb = new StringBuffer();
	  sb.append("select count(*) from  arealm_merge a, pointlm_merge p where ST_Intersects(p.geom, a.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public  String getSelectPointIntersectsLine(){
	  StringBuffer sb = new StringBuffer();
	  sb.append("select count(*) from  edges_merge e, pointlm_merge p where ST_Intersects(p.geom, e.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public  String getSelectPointEqualsPoint(){
	  StringBuffer sb = new StringBuffer();
	  sb.append("select count(*) from  pointlm_merge p1, pointlm_merge p2 where ST_Equals(p1.geom, p2.geom)");
	  String sql = sb.toString();
	  // System.out.println("The query "+ sql);
	  return sql;
  }
  ...
  public String getInsertIntoArealmMerge(){
	  ...
	  /*
	  sb.append("insert into arealm_merge (statefp, countyfp, ansicode, areaid, fullname, mtfcc, geom) values ('48','001','','110223506483','TEMP','K1237', ST_GeometryFromText('MULTIPOLYGON(((-95.835919 31.758732,-95.83358 31.758691,-95.83335 31.758687,-95.831252 31.75865,").append(nxt1)
...
;
  ...
  public  String getStreetAddressForReverseGeocoding(){ 
	  ...
	  // Generate the join SQL statement.
	  //sb.append("SELECT  fullname,lfromadd,ltoadd,rfromadd,rtoadd,zipl,zipr, distance(geom, GeomFromText(?,"+SRID+" )) " + " as d FROM edges_merge " +
      //          "  where geom && ?::box3d  " +
      //          "  and distance(geom, GeomFromText(?,"+SRID+" )) < 50 " +
      //          "  and  roadflg='Y' order by d limit 1;");
	  
	  sb.append("SELECT fullname,lfromadd,ltoadd,rfromadd,rtoadd,zipl,zipr, distance(geom, GeomFromText(?,"+SRID+" ))  as d FROM edges_merge   where St_Intersects(geom, GeomFromText(?,"+SRID+"))    and distance(geom, GeomFromText(?,"+SRID+" )) < 0.1   and  roadflg='Y' order by d limit 1 "); //'POINT(-97.74331964136722 30.41450086861228)','POLYGON ((-97.72610571362193 30.426874127719113, -97.74610571362194 30.426874127719113, -97.74610571362194 30.40687412771911, -97.72610571362193 30.40687412771911, -97.72610571362193 30.426874127719113))','POINT(-97.74331964136722 30.41450086861228)'
  ...
  public String[] getLandUseQueries() { 
	...
	/* gisdb=> select acreage, shape_area, marketvalu, st_area(pa.geom), pa.marketvalu/(st_area(pa.geom)/43560) from parcels2008 as pa where pa.land_state like 'A%' limit 2;
	...
	//queries[0] = "select sum(pa.marketvalu)/sum(st_area(pa.geom)/43560) from parcels2008 as pa, land_use_2010 as lu where lu.parcel_id_=pa.geo_id  and lu.land_use_2=220 and shape_sour='TCAD'";
	...
	queries[0] = "select sum(pa.market_val)/sum(st_area(pa.geom)) from parcels2016 as pa where pa.py_state like 'A%'";
	  
	//How many residential properties have a  hospital within one mile radius in Austin 
	queries[1] = "select count(*) from  land_use_2010 as lu, hospitals as h where lu.general_la in (100,113,150,160,200) and  st_dwithin(lu.geom, h.geom, 5280)";
	...
	queries[2] = "select sc.name, avg(pa.market_val) as avg_property_value from parcels2016 as pa, hospitals as sc where st_dwithin(pa.geom, sc.geom, 5280) group by sc.name order by avg_property_value desc";

	//Projection not same: Determine the avg property values within a one mile radius of all schools in Travis county 
	//queries[0] = " select sc.name, avg(pa.marketvalu) as avg_property_value from parcels2008 as pa, gnis_names09  as sc where sc.class='School' and st_dwithin(pa.geom, sc.geom, 5280) group by sc.name order by avg_property_value ";
	...
	//			 " st_dwithin(lake.geom, pa.geom, 100) order by property_value desc";
	...
	//queries[3] = "select lake.wtr_nm, geo_id, pa.marketvalu as property_value from parcels2008 as pa, s_wtr_ar as lake where  st_dwithin(lake.geom, pa.geom, 100) and pa.marketvalu> 0  limit 10";
	queries[3] = "select lake.wtr_nm, geo_id, pa.market_val as property_value from parcels2016 as pa, s_wtr_ar as lake where  st_dwithin(lake.geom, pa.geom, 100) and pa.market_val > 0  limit 10";
   	
	
	//Rich people: area in acres and property values of large lot single family properties with area greater than 100 acres
	//queries[4] = " select property_i,  ST_Area(lu.geom)/43560 as cal_area, pa.marketvalu as property_value from  land_use_2010 as lu, parcels2008 as pa  where lu.general_la=160  and lu.parcel_id_=pa.geo_id and ST_Area(lu.geom)/43560>100  order by cal_area desc";
  
	//Which office buildings have front yard parking restrictions 
	queries[4] = "select property_i from  land_use_2010 as lu, frontyard_parking_restrictions fypr where lu.general_la=400  and  ST_Overlaps(fypr.geom, lu.geom)";
				  
	
	// Is there any land boundary legal issues?  (Return the area of land we have, union dissolves overlaps)
	//queries[6] = " SELECT SUM(ST_Area(geom))/1000 As totalwithoverlap_km, ST_Area(ST_Union(geom))/1000 As no_overlap_km FROM land_use_2010";

	
	// Show the commercial properties that are built on un-permitted landfills
	queries[5] = "select lu.property_i from  land_use_2010 as lu, landfills lf where lu.general_la=300 and lf.permitted='UNPERMITTED' and ST_Intersects(lf.geom,lu.geom)";
				  

	///////////////////////////////////// EXTRA ////////////////////////////////////////////////////////////
	//what is the value per square foot 
	//queries[0] = "select sum(marketvalu)/sum(st_area(geom)/43560) from parcels2008"; 
	...
	//queries[5] = "SELECT p.parcel_id_, COUNT(o.parcel_id_) As totinter  FROM land_use_2010 As p " +
	//	" INNER JOIN land_use_2010 As O ON (p.parcel_id_ <> o.parcel_id_ AND ST_Intersects(p.geom, o.geom))  GROUP BY p.parcel_id_ ORDER BY p.parcel_id_";
  
	 //3. Determine the property value within a one mile radius for all schools in Travis county 
    //(projection different)
	//queries[1] = "select sc.campname, sum(pa.marketvalu)/sum(st_area(pa.geom)/43560) as avg_property_value from parcels2008 as pa, schools as sc where sc.cntyname like 'TRAVIS%' and st_within(pa.geom, sc.geom, 5280) " +
	...
	//queries[3] = "select sc.park_name, sum(pa.marketvalu)/sum(st_area(pa.geom)/43560) as avg_property_value from parcels2008 as pa, coa_parks as sc where " + 
	//			 " st_dwithin(pa.geom, sc.geom, 5280)   group by sc.park_name  order by avg_property_value desc";
    //
...
//////////////////////////////////////////MACRO BENCHMARK: ENVIRONMENTAL HAZARD /////////////////////////////////
  public String[] getEnvHazardQueries() { 
	...
	//queries[2] = "select   sum(st_area(fa.geom)/43560) as hr_flood_area from s_fld_haz_ar fa, s_wtr_ar wa where wa.wtr_nm='Lake Travis' and (fld_zone='A' or fld_zone='AE' or fld_zone='AO' or fld_zone='V') and st_dwithin(fa.geom, wa.geom, 5280) ";
	//queries[2] = "select fld_ar_id, st_area(fa.geom)/43560 as flood_area from s_fld_haz_ar fa, s_wtr_ar wa where wa.wtr_nm='Lake Travis' and (fld_zone='A' or fld_zone='AE' or fld_zone='AO' or fld_zone='V') and st_dwithin(fa.geom, wa.geom, 5280)  limit 1 ";
	...
	// queries[3] = "select lu.property_i from  land_use_2010 as lu,  s_fld_haz_ar fz where lu.general_la in (100,113,150,160,200) and (fld_zone='A' or fld_zone='AE' or fld_zone='AO' or fld_zone='V') and st_overlaps(lu.geom, fz.geom)";
	queries[2] = "select lu.property_i from  land_use_2010 as lu,  s_fld_haz_ar fz where lu.general_la in (100,113,150,160,200) and (fld_zone='A' or fld_zone='AE' or fld_zone='AO' or fld_zone='V') and st_overlaps(lu.geom, fz.geom) limit 10 ";
	
	//rewritten; wait: Which industrial complexes are in high risk flood area?
	//queries[] = "select lu.property_i from  land_use_2010 as lu,  s_fld_haz_ar fz where lu.general_la=500 and (fld_zone='A' or fld_zone='AE' or fld_zone='AO' or fld_zone='V') and st_overlaps(lu.geom, fz.geom)";
	 queries[3] = "select lu.property_i from  land_use_2010 as lu,  s_fld_haz_ar fz where lu.general_la=500 and (fld_zone='A' or fld_zone='AE' or fld_zone='AO' or fld_zone='V') and st_overlaps(lu.geom, fz.geom) limit 10 ";
